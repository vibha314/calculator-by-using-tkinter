...
label_result = Label(root,font=("arial",30),text="",width=25,height=2)
label_result.pack()

Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#FFC0CB",command=lambda:clear()).place(x=10,y=100)
...
Button(root,text="=",width=5,height=3 ,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#0000FF",command=lambda:calculate()).place(x=430,y=400)
